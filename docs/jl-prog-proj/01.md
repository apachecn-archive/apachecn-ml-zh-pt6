<title>Getting Started with Julia Programming</title>  
...
<title>Concise, readable, and intuitive syntax</title>  
...
<title>Powerful and productive dynamic type system</title>  
...
<title>Designed for parallelism and distributed computation</title>  
...
<title>Efficient intercommunication with other languages</title>  
...
<title>Powerful REPL and shell-like capabilities</title>  
...
<title>Official Windows installer</title>  
...
<title>Interacting with the REPL</title>  
...
<title>Accessing the documentation with the help mode</title>  
...
<title>The startup.jl file</title>  
...
<title>Custom package installation</title>  
...
<title>Checking the package status</title>  
...
`Pkg` also supports a series of shortcuts, if you want to save a few keystrokes. In this case, `st` can be used instead of `status`.<title>Using packages</title>  
...
`OhMyREPL` has a few more cool features up its sleeve—you can learn about them by checking the official documentation at [https://kristofferc.github.io/OhMyREPL.jl/latest/index.html](https://kristofferc.github.io/OhMyREPL.jl/latest/index.html).<title>One more step</title>  
...
<title>Discovering packages</title>  
...
<title>Registered versus unregistered</title>  
