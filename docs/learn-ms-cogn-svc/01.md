<title>Getting Started with Microsoft Cognitive Services</title> 
...
我们使用身份验证对象来检索访问令牌。这个令牌用在我们的授权令牌字符串中，正如我们前面看到的，它是在我们的头中传递的。如果应用程序由于某种原因未能生成访问令牌，我们将触发一个错误事件。
